...
class BaselineTaskDataTest(tf.test.TestCase, parameterized.TestCase):
  ...
  def test_raises_when_train_and_test_types_are_different_no_preprocessing(
    ...
    with self.assertRaisesRegex(
      ...
      task_data.BaselineTaskData(train_data=train_data, test_data=test_data)
  ...
  def test_constructs_without_eval_preprocess_fn(self):
    ...
    test_task_data = task_data.BaselineTaskData(
        train_data=create_client_data(10),
