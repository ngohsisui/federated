...
def transform_to_native_form(
  ...
  Args:
    ...
    grappler_config: Configuration for Grappler optimizations to perform on the
      TensorFlow computations. Set
      `grappler_config.rewrite_config.disbale_meta_optimizer=True` to disable
      Grappler optimization. If `None`, default optimizations wil be applied.
